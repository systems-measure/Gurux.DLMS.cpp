...
typedef enum {
  ...
  DLMS_UNIT_SEC = 7,
  DLMS_UNIT_GRADE = 8,
  DLMS_UNIT_CELSIUS_DEG = 9,
  DLMS_UNIT_CURRENCY = 10,
  //--
  DLMS_UNIT_JOULE_HOUR = 26,
  DLMS_UNIT_WATT = 27,
  DLMS_UNIT_VOLTAMPERE = 28,
  DLMS_UNIT_VAR = 29,
  DLMS_UNIT_WATT_HOUR = 30,
  DLMS_UNIT_VOLTAMPERE_HOUR = 31,	
  DLMS_UNIT_VAR_HOUR = 32,
  DLMS_UNIT_AMPERE = 33,
  DLMS_UNIT_PENDANT = 34,
  DLMS_UNIT_VOLT = 35,
  DLMS_UNIT_VOLT_ON_M = 36,
  DLMS_UNIT_FARAD = 37,
  DLMS_UNIT_OM = 38,
  DLMS_UNIT_OM_ON_METER = 39,
  DLMS_UNIT_WEBER = 40,
  DLMS_UNIT_DLMS_UNIT_TESLA = 41,
  DLMS_UNIT_AMPERE_ON_METER = 42,
  DLMS_UNIT_HENRY = 43,
  DLMS_UNIT_HERTZ = 44,
  DLMS_UNIT_IMPULSE_ON_WAT_HOUR = 45,
  DLMS_UNIT_IMPULSE_ON_VAR_HOUR = 46,
  DLMS_UNIT_IMPULSE_ON_VOLTA_MPERE_HOURE = 47,
  DLMS_UNIT_VSQRH = 48,
  DLMS_UNIT_ASQRH = 49,
  DLMS_UNIT_KILOGRAM_SEC = 50,
  //---
  DLMS_UNIT_OTHER_UNIT = 254,
  DLMS_UNIT_SCORE = 255,
}DLMS_UNITS_TYPE;
